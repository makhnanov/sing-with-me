      ...
      <div class="backlog">
        <table class="darkTable">
          ...
          <tr>
            ...
            <td>Bakirov Roman</td>
            <td>Contact:</td>
            <td><a class="router-link-active router-link-exact-active" href="tg://resolve?domain=BakirovRoman">https://t.me/BakirovRoman</a></td>
          </tr>
          </tfoot>
          <tbody>
          <tr>
...
.text-block {
  ...
  z-index: 1;
  top: -4000px;
  animation: move 361s linear alternate;
}
.resume {
  display: flex;
